...
const NavBar = props => {
  ...
  return (<>
        ...
        {/* 顶部导航菜单栏 */}
        <nav id='nav' className={`${fixedNav ? 'fixed' : 'relative bg-none'} ${textWhite ? 'text-white ' : 'text-black dark:text-white'}  ${navBgWhite ? 'bg-white dark:bg-[#1a191d]' : 'bg-none'} z-20 h-16 top-0 w-full`}>
