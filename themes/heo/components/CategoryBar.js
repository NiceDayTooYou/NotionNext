...
export default function CategoryBar(props) {
  ...
  ${border ? 'lg:border lg:hover:border dark:lg:border-gray-50 hover:border-gray-900 dark:hover:border-green-400 ' : ''}  py-2 lg:px-2 rounded-xl transition-colors duration-200`}>
