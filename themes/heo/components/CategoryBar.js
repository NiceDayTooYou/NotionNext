...
export default function CategoryBar(props) {
  ...
  ${border ? 'lg:border lg:hover:border dark:lg:border-gray-50 hover:border-gray-900 dark:hover:border-green-400 ' : ''}  py-2 lg:px-2 rounded-xl transition-colors duration-200`}>
        ...
        <div id='category-bar-next' className='flex items-center justify-center'>
            ...
            <Link href='/category' className='whitespace-nowrap font-bold text-gray-900 dark:text-white transition-colors duration-200 hover:text-green-500'>
...
const MenuItem = ({ href, name }) => {
  ...
  return <div className={`whitespace-nowrap mr-2 duration-200 transition-all font-bold px-2 py-0.5 rounded-md text-gray-900 dark:text-black hover:text-black hover:bg-[#ffffff] dark:hover:bg-green-500 ${selected ? 'text-white bg-[#000000] dark:bg-[#ffffff]' : ''}`}>
