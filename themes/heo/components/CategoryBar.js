...
export default function CategoryBar(props) {
  ...
  ${border ? 'lg:border lg:hover:border dark:lg:border-gray-900 hover:border-gray-900 dark:hover:border-green-400 ' : ''}  py-2 lg:px-2 rounded-xl transition-colors duration-200`}>
        ...
        <div id='category-bar-next' className='flex items-center justify-center'>
            ...
            <Link href='/category' className='whitespace-nowrap font-bold text-gray-900 dark:text-white transition-colors duration-200 hover:text-white'>
...
const MenuItem = ({ href, name }) => {
  ...
  return <div className={`whitespace-nowrap mr-2 duration-200 transition-all font-bold px-2 py-0.5 rounded-md text-gray-900 dark:text-white hover:text-white hover:bg-geay-900 dark:hover:bg-gray-900 ${selected ? 'text-white bg-gray-900 dark:bg-gray-900' : ''}`}>
