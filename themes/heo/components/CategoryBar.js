...
const MenuItem = ({ href, name }) => {
  ...
  return <div className={`whitespace-nowrap mr-2 duration-200 transition-all font-bold px-2 py-0.5 rounded-md text-gray-900 dark:text-black hover:text-black hover:bg-[#ffffff] dark:hover:bg-[#ffffff] ${selected ? 'text-white bg-[#000000] dark:bg-[#000000]' : ''}`}>
