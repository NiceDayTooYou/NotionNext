...
export function InfoCard(props) {
  ...
  return (
        <Card className='bg-[#ffffff] dark:bg-true-gray-900 text-white flex flex-col w-72 overflow-hidden relative'>
            {/* 信息卡牌第一行 */}
            ...
            <div className='flex justify-between'>
                <div className='flex space-x-3  hover:text-black dark:hover:text-white'>
                    {/* 两个社交按钮 */}
                    <div className='bg-gray-900 p-2 rounded-full  transition-colors duration-200 dark:bg--900 dark:hover:bg-black hover:bg-white'>
                        <Link href='/about'><GlobeAlt className={'w-6 h-6'} /></Link>
                    </div>
                    <div className='bg-gray-900 p-2 rounded-full w-10 items-center flex justify-center transition-colors duration-200 dark:bg-gray-900 dark:hover:bg-black hover:bg-white'>
