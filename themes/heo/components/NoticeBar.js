...
export function NoticeBar() {
  ...
  return (
        <div className="max-w-[86rem] w-full mx-auto flex h-12 mb-4 px-5 font-bold">
            <div className="animate__animated animate__fadeIn animate__fast group cursor-pointer bg-white dark:bg-[#1e1e1e] dark:text-white hover:border-gray-900 dark:hover:border-green-500 border dark:border-gray-50  duration-200 hover:shadow-md transition-all rounded-xl w-full h-full flex items-center justify-between px-5">
                <span className='whitespace-nowrap'>Moment</span>
                <div className="w-full h-full hover:text-green-500 flex justify-center items-center">
                    <Swipe items={notices} />
                </div>
