        ...
        <div id='article-end'>
            ...
            <section className='lg:hidden pt-8 text-gray-900 items-center text-xs md:text-sm flex flex-col m-1 '>
                <Link
                    href={`/${prev.slug}`}
                    passHref
                    className='cursor-pointer justify-between space-y-1 px-5 py-6 rounded-t-xl dark:bg-[#1e1e1e] border dark:border-gray-50 border-b-0 items-center dark:text-white flex flex-col w-full h-18 duration-200'
                >
                ...
                <Link
                    href={`/${next.slug}`}
                    passHref
                    className='cursor-pointer justify-between space-y-1 px-5 py-6 rounded-b-xl dark:bg-[#1e1e1e] border dark:border-gray-50 items-center dark:text-white flex flex-col w-full h-18 duration-200'
                >
            ...
            <div id='pc-next-post' className={`hidden md:block fixed z-40 right-24 bottom-4 duration-200 transition-all ${isScrollEnd ? 'mb-0 opacity-100' : '-mb-24 opacity-0'}`}>
                <Link
                    href={`/${next.slug}`}
                    className='cursor-pointer drop-shadow-xl duration transition-all h-24 dark:bg-[#1e1e1e] border dark:border-gray-50 p-3 bg-white dark:text-gray-50 dark:hover:text-green-400 hover:text-white hover:font-bold hover:bg-gray-900 rounded-lg flex flex-col justify-between'
                >
