                        ...
                        <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
                            ...
                            >
                                <Dialog.Panel className="pointer-events-auto relative w-96 max-w-md">
                                    ...
                                    {/* 内容 */}
                                    <div className="flex h-full flex-col overflow-y-scroll bg-white dark:bg-[#000000] py-6 shadow-xl">
                                        <div className="relative mt-6 flex-1 flex-col space-y-3 px-4 sm:px-6 dark:text-white ">
                                            ...
                                            <section className='space-y-2 flex flex-col'>
                                                ...
                                                <div className='gap-2 grid grid-cols-2'>
                                                    <Button title={'主页'} url={'/'} />
                                                    <Button title={'关于'} url={'https://flowcv.com/resume/ww2mhitt2c'} />
                                                </div>
                                                {/* 用户自定义菜单 */}
                                                <MenuListSide {...props}/>
                                            </section>
...
function DarkModeBlockButton() {
  ...
  return <button onClick={handleChangeDarkMode} className={'group duration-200 hover:text-white hover:shadow-md hover:bg-gary-900 flex justify-between items-center px-2 py-2 border dark:border-gray-900 bg-white dark:bg-[#000000]  rounded-lg'}>
...
function Button({ title, url }) {
  return <Link href={url} className={'duration-200 hover:text-white hover:shadow-md flex cursor-pointer justify-between items-center px-2 py-2 border dark:border-gray-900 bg-white hover:bg-gary-900 dark:bg-[#000000] rounded-lg'}>
        {title}
    </Link>
}
